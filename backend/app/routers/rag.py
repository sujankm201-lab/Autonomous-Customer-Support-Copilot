...
async def query_knowledge_base(
    ...
    """Query the knowledge base with intent detection."""

    logger.info(
        f"User {current_user['_id']} queried: {request.query}"
    )

    try:
        # Detect the customer's intent first
        ...
        # Return the existing RAG response plus intent
...
async def index_documents(
    ...
    try:
        ...
        return {
            "message": f"Indexed {num_indexed} chunks",
